...
<head>
    ...
    <link href='{{url("https://fonts.googleapis.com/css2?family=Rubik:ital,wght@0,300..900;1,300..900&display=swap")}}'
          rel="stylesheet">
    <!-- Vendor CSS Files -->
    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center">
            <div class="col-xl-9 d-flex align-items-center justify-content-lg-between">
                <h1 class="logo me-auto me-lg-0"><a href="{{route('main.index')}}">مالز</a></h1>
                ...
                <nav id="navbar" class="navbar order-last order-lg-0">
                    <ul>
                        ...
                        <li><a class="nav-link scrollto " href="#portfolio"> اخبار</a></li>
                        <li><a class="nav-link scrollto" href="#pricing">تخفیفات</a></li>
                        <li class="dropdown"><a href="#"><span>مجتمع ها</span> <i class="bi bi-chevron-down"></i></a>
                            <ul>
                ...
                <div class="col-lg-7 d-flex flex-column justify-content-center align-items-stretch  order-2 order-lg-1">
                    ...
                    <div class="accordion-list">
                        <ul>
                            ...
                            <li>
                                <a data-bs-toggle="collapse" data-bs-target="#accordion-list-2" class="collapsed">Feugiat
                            ...
                            <li>
                                <a data-bs-toggle="collapse" data-bs-target="#accordion-list-3" class="collapsed">Dolor
